...
console.log(GridIcon, ChevronDownIcon, HorizontaLDots);
...
const navItems: NavItem[] = [
  { icon: <GridIcon />, name: "Dashboard", subItems: [{ name: "Ecommerce", path: "/dashboard", pro: false }] },
  { icon: <CalenderIcon />, name: "Calendar", path: "/dashboard/calendar" },
  { icon: <UserCircleIcon />, name: "User Profile", path: "/dashboard/profile" },
  { name: "Forms", icon: <ListIcon />, subItems: [{ name: "Form Elements", path: "/dashboard/form-elements" }] },
  { name: "Tables", icon: <TableIcon />, subItems: [{ name: "Basic Tables", path: "/dashboard/basic-tables" }] },
  { name: "Pages", icon: <PageIcon />, subItems: [{ name: "Blank Page", path: "/dashboard/blank" }, { name: "404 Error", path: "/dashboard/error-404" }] },
];

const othersItems: NavItem[] = [
  { icon: <PieChartIcon />, name: "Charts", subItems: [{ name: "Line Chart", path: "/dashboard/line-chart" }, { name: "Bar Chart", path: "/dashboard/bar-chart" }] },
  { icon: <BoxCubeIcon />, name: "UI Elements", subItems: [{ name: "Alerts", path: "/dashboard/alerts" }, { name: "Avatar", path: "/dashboard/avatars" }, { name: "Badge", path: "/dashboard/badge" }, { name: "Buttons", path: "/dashboard/buttons" }, { name: "Images", path: "/dashboard/images" }, { name: "Videos", path: "/dashboard/videos" }] },
  { icon: <PlugInIcon />, name: "Authentication", subItems: [{ name: "Sign In", path: "/dashboard/signin" }, { name: "Sign Up", path: "/dashboard/signup" }] },
];
      ...
      {items.map((nav, index) => (
        <li key={nav.name}>
          ...
          {nav.subItems && (isExpanded || isHovered || isMobileOpen) && (
            <div  ref={(el) => void (subMenuRefs.current[`${menuType}-${index}`] = el)}
